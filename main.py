...
Tommonkey                 Ver:1.0.1
    ...
    getNameId = config.getNameId
    getPasswordId = config.getPasswordId
    ...
    status,username,password = loginLogic(target,getNameId,getPasswordId,error_username,error_password,submitXPATH,usernameList,passwordList)
    if status == 0:
        print(
            """
            ***************************
